...
export const spots = [
  ...
  },
  {
    ...
    longDescription:
      "Discover the beauty of nature through our guided kayak tours. Explore serene rivers, rugged coastlines, and get up close with local wildlife in their natural habitat.",
    averageRating: 3,
  ...
  },
  {
    ...
    longDescription:
      "Embark on a sailing adventure with our certified sailing school. Learn navigation, boat handling, and safety on the open sea, guided by experienced sailors.",
    averageRating: 3,
  ...
  },
  {
    ...
    longDescription:
      "Dive into the ocean's depths with our scuba diving discovery program. Explore coral reefs, encounter marine life, and uncover the mysteries of the underwater world.",
    averageRating: 2,
  ...
  },
  {
    ...
    longDescription:
      "Our snowboarding camp is designed for enthusiasts of all levels. From beginner to advanced, improve your skills with professional coaching on some of the best slopes.",
    averageRating: 1,
